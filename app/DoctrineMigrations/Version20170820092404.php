...
class Version20170820092404 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql(sprintf(
            ...
            '("%s", "%s", NOW(), NOW()), '.
            '("%s", "%s", NOW(), NOW())',
            'bachelor', PropertyDisposition::DISPOSITION_1,
            ...
            '2+2', PropertyDisposition::DISPOSITION_2_1,
            '3+kk', PropertyDisposition::DISPOSITION_3_kk,
            '3+3', PropertyDisposition::DISPOSITION_3_1,
            '4+kk', PropertyDisposition::DISPOSITION_4_kk,
            '4+4', PropertyDisposition::DISPOSITION_4_1,
            '5+kk', PropertyDisposition::DISPOSITION_5_kk,
            '5+5', PropertyDisposition::DISPOSITION_5_1,
            '6+', PropertyDisposition::DISPOSITION_6,
            'other', PropertyDisposition::DISPOSITION_other
        ));
        ...
        $this->addSql(sprintf(
            ...
            '("%s", "%s", NOW(), NOW()), '.
            '("%s", "%s", NOW(), NOW())',
            'Flat', PropertyType::TYPE_FLAT,
            'House', PropertyType::TYPE_HOUSE,
            'Land', PropertyType::TYPE_LAND
        ));
        ...
        $this->addSql(sprintf(
            ...
            '("%s", "%s", NOW(), NOW()), '.
            '("%s", "%s", NOW(), NOW())',
            'For demolition', PropertyCondition::CONDITION_DEMOLITION,
            'In development', PropertyCondition::CONDITION_DEVELOPMENT,
            'Good', PropertyCondition::CONDITION_GOOD,
            'New', PropertyCondition::CONDITION_NEW,
            'Poor', PropertyCondition::CONDITION_POOR,
            'Renovated', PropertyCondition::CONDITION_RENOVATED,
            'Under construction', PropertyCondition::CONDITION_UNDER_CONSTRUCTION
        ));
        ...
        $this->addSql(sprintf(
            ...
            '("%s", "%s", NOW(), NOW()), '.
            '("%s", "%s", NOW(), NOW())',
            'Brick', PropertyConstruction::CONSTRUCTION_BRICK,
            'Panel', PropertyConstruction::CONSTRUCTION_PANEL
        ));
        ...
        $this->addSql(sprintf(
            ...
            '("%s", "%s", NOW(), NOW()), '.
            '("%s", "%s", NOW(), NOW())',
            'sreality.cz', Source::SOURCE_SREALITY,
            'bazos.cz', Source::SOURCE_BAZOS
        ));
    }
