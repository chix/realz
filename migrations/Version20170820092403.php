...
class Version20170820092403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE push_notification_token (id INT AUTO_INCREMENT NOT NULL, token VARCHAR(255) NOT NULL, active TINYINT(1) DEFAULT \'1\' NOT NULL, error_count INT DEFAULT 0 NOT NULL, last_response LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', enabled TINYINT(1) DEFAULT \'1\' NOT NULL, filters LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX token_idx (token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
